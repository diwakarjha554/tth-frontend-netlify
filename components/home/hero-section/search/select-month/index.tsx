    ...
    return (
        <div className="w-full relative cursor-pointer" onClick={() => setIsOpen(!isOpen)}>
            <div className="relative">
                <div className="backdrop-filter backdrop-blur-md bg-opacity-30 bg-gray-500 lg:backdrop-filter-none md:bg-transparent w-full pr-5 pl-10 py-5 border-r-gray-500 rounded lg:rounded-none lg:rounded-l-xl focus:outline-none">
