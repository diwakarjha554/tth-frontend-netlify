    ...
    return (
        <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
                <AccordionTrigger className="hover:no-underline md:text-lg font-medium text-start">
                    What makes Travel Trail Holidays special among other travel companies ?
                </AccordionTrigger>
                <AccordionContent className="text-xs md:text-sm text-neutral-700 dark:text-neutral-300">
