    ...
    return (
        <Accordion type="single" collapsible>
            ...
            <AccordionItem value="item-2">
                ...
                <AccordionContent className="text-base text-neutral-700">
                    Booking a travel package with us is effortless! Simply visit our website to submit a travel inquiry or DM us on social media. Our dedicated team will quickly provide you with all the information and guidance you need.
                </AccordionContent>
            </AccordionItem>
            <AccordionItem value="item-3">
                ...
                <AccordionContent className="text-base text-neutral-700">
                    At Travel Trail Holidays, safety is our top priority. We take extra measures to ensure the comfort and security of solo female travelers. Our Team Captains receive specialized training to provide a seamless and secure experience, with a strong focus on women's safety.
                </AccordionContent>
            </AccordionItem>
        </Accordion>
    );
