    ...
    <div className='relative'>
      ...
      {isOpen && (
        <div className='absolute bg-background border top-12 right-0 rounded-xl w-64 p-1'>
          <MenuItems href='' title='Account' icon={AiOutlineUser} className='bg-background rounded-xl hover:bg-gray-200 dark:hover:bg-gray-500/40' />
          <MenuItems href='' title='Wishlist' icon={RiHeartFill} className='bg-background rounded-xl hover:bg-gray-200 dark:hover:bg-gray-500/40' />
          ...
          <DarkModeBtn />
          <MenuItems href='' title='Logout' icon={RiLogoutCircleRLine} className='bg-background rounded-xl hover:bg-gray-200 dark:hover:bg-gray-500/40' />
        </div>
      )}
    </div>
  )
